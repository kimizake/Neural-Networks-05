...
class PricingModel():
    ...
    def __init__(self, calibrate_probabilities=False):
        ...
        # =============================================================
        self.base_classifier = CC()  # ADD YOUR BASE CLASSIFIER HERE
    ...
    def _preprocessor(self, X_raw):
        ...
        X_raw.drop(columns=["id_policy", "pol_insee_code"], inplace=True)

        X_raw["drv_sex2"].fillna("unknown", inplace=True)
        ...
        for col in X_raw:
            if X_raw[col].dtype == 'object':
                print(X_raw[col].astype('str').dtype)
            print(X_raw[col].dtype)
            # print(lb.fit_transform(X_raw[col]))

        return None  # YOUR CLEAN DATA AS A NUMPY ARRAY
